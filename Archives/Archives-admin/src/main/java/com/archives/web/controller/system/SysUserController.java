...
import com.archives.system.service.ISysPostService;
import com.archives.system.service.ISysRoleService;
import com.archives.system.service.ISysUserService;

import static com.archives.common.core.domain.AjaxResult.success;
...
//    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    ...
    public AjaxResult userList(SysUser user) {
        List<SysUser> result = userService.userList(user);
