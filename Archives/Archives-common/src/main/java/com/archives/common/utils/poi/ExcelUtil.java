package com.archives.common.utils.poi;
...
import com.archives.common.exception.UtilException;
import com.archives.common.utils.DateUtils;
import com.archives.common.utils.DictUtils;
...
import com.archives.common.utils.file.ImageUtils;
import com.archives.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public Cell createHeadCell(Excel attr, Row row, int column)
    {
        ...
        if(attr.name().contains("!")){
            String name = attr.name().replace("!", "");
            CellStyle style = wb.createCellStyle();
            style.setFillForegroundColor(YELLOW.getIndex());// 设置单元格背景色
            style.setFillPattern(FillPatternType.SOLID_FOREGROUND);// 设置单元格背景填充模式
            Font font = wb.createFont();
            font.setFontName("Arial");// 设置字体
            font.setFontHeightInPoints((short) 10);// 设置字体大小
            font.setColor(BLACK.getIndex());// 设置字体颜色
            font.setBold(true);// 设置字体加粗
            style.setFont(font);// 设置字体
            style.setAlignment(HorizontalAlignment.CENTER);// 设置水平居中
            style.setBorderBottom(BorderStyle.THIN); // 设置下边框为细线
            style.setBorderLeft(BorderStyle.THIN); // 设置左边框为细线
            style.setBorderRight(BorderStyle.THIN); // 设置右边框为细线
    ...
    {
        String downloadPath = ArchivesConfig.getDownloadPath() + filename;
