...
<!--          placeholder="请输入存储的category_id"-->
<!--          clearable-->
<!--          @keyup.enter.native="handleQuery"-->
<!--        />-->
<!--      </el-form-item>-->
      <el-form-item label="类型" prop="syllable">
        <el-input
...
<!--        </el-form-item>-->
        <el-form-item label="科技类型" prop="syllable">
          <el-input v-model="form.syllable" placeholder="请输入类型" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        id: null,        categoryId: 35,        syllable: null      };
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
    handleQuery() {
