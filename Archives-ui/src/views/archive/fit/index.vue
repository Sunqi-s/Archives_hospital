  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="分类字段" prop="syllable">
          <el-input v-model="form.syllable" :placeholder="form.syllablePlaceholder" clearable />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      // 表单参数
      form: {categoryId: null,  syllable: null,  query: null,  syllablePlaceholder:'请选择档案分类'},
      // 表单校验
      rules: {
        categoryId: [
      ...
      categoryOptions: [
        {
          ...
          label:'文件目录',
          query:'field1',
          syllablePlaceholder :'请输入年份'
        },
        {
          value:'35',
          label:'科技案卷',
          query:'field8',
          syllablePlaceholder :'请输入科技类别'
        },
        {
          value:'69',
          label:'文件目录(密)',
  ...
  watch: {
    'form.categoryId': function (newCategoryId) {
      if (newCategoryId) {
        const selectedOption = this.categoryOptions.find(option => option.value === newCategoryId);
        if (selectedOption) {
          this.form.query = selectedOption.query;
          this.form.syllablePlaceholder = selectedOption.syllablePlaceholder;
        }
      } else {
        this.form.syllablePlaceholder = '请选择档案分类'; // 没有选择分类时的默认提示
      }
    }
  },
  methods: {
