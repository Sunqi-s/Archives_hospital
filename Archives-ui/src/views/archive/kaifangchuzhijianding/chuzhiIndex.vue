...
<!--        />-->
<!--      </el-form-item>-->
      <el-form-item label="处置者" prop="createBy">
        <el-input
...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['archive:dispose:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['archive:dispose:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['archive:dispose:remove']"
        >删除</el-button>
      </el-col>
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['archive:dispose:export']"-->
<!--        >导出</el-button>-->
<!--      </el-col>-->
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="disposeList" @selection-change="handleSelectionChange">
...
<!--      <el-table-column label="档案id" align="center" prop="archiveId" />-->
      ...
      <el-table-column label="处置者" align="center" prop="createBy" />
...
<script>
import { listDispose, getDispose, delDispose, addDispose, updateDispose } from "@/api/archive/dispose";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除处置记录编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('archive/dispose/export', {
        ...this.queryParams
