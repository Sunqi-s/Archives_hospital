...
<!--        />-->
<!--      </el-form-item>-->
      <el-form-item label="开放者" prop="createBy">
        <el-input
      ...
      <el-form-item label="开放时间" prop="createTime">
...
<!--      </el-col>-->
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['archive:open:remove']"
        >删除</el-button>
      </el-col>
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['archive:open:export']"-->
<!--        >导出</el-button>-->
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="openList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开放者" align="center" prop="createBy" />
      <el-table-column label="开放时间" align="center" prop="createTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="开放者" prop="createBy">
          <el-input v-model="form.createBy" :readonly="true" placeholder="请输入开放者" />
        </el-form-item>
      </el-form>
...
<script>
import { listOpen, getOpen, delOpen, addOpen, updateOpen } from "@/api/archive/open";
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        archiveId: null,        title: null,        createBy: null,        createTime: null,        archiveNumber: null      },
      // 表单参数
      form: {},
      // 表单校验
      rules: {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除公开记录编号为"' + ids + '"的数据项？').then(function() {
        return delOpen(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('archive/open/export', {
        ...this.queryParams
