<template>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="20" :xs="24" v-show="categoryId && !showPasswordPrompt">
          ...
          <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
              <el-button type="success" icon="el-icon-s-flag" size="small" @click="handelGongkai">公开</el-button>
            </el-col>
          </el-row>
  ...
  import { addOpen } from '@/api/archive/open'
  export default {
    name: "Resources",
