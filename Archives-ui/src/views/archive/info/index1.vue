      ...
      <el-col :span="20" :xs="24" v-show="categoryId && !showPasswordPrompt">
        ...
        <el-drawer class="search-drawer" title="高级搜索" :visible.sync="drawer" :with-header="true">
          ...
          <div class="form-button-wrapper">
            <el-button type="primary" icon="el-icon-search" size="small" @click="handleQueryBeach"
...
import { getBeachList, getInfo, listInfo, sendInfo, updatAarchiveStatus, updateArchiveStatusById, sendInfoByIds,sendInfoAll,updatAarchiveStatusAll } from '@/api/archive/info'
